...
describe("coffeemate", () => {
  ...
  describe("when the coffee queue is initially empty", () => {
    ...
    it("sends an ephemeral message subsequent time a user asks for coffee and does nothing to the queue", async () => {
      await handler(message);
  ...
  describe("when the coffee queue begins with a user in it", () => {
    ...
    it("sends an ephemeral message the first time a user asks for coffee and does nothing to the queue", async () => {
      await handler(message);
